...
Set-ADUSer TEST_USER_FIRST_NAME.TEST_USER_LAST_NAM -Title "MANAGER_TEST"
...
Set-ADUser TEST_USER_FIRST_NAME.TEST_USER_LAST_NAM -Displayname "TEST_USER_FIRST_NAME TEST_USER_LAST_NAME"
Set-ADUser TEST_USER_FIRST_NAME.TEST_USER_LAST_NAM -Department Sales
Set-ADUser TEST_USER_FIRST_NAME.TEST_USER_LAST_NAM -EmailAddress TEST_USER_FIRST_NAME.TEST_USER_LAST_NAM@testcompany.com
